'''
Inspired by PyImageSearch blog: https://www.pyimagesearch.com/2017/09/18/real-time-object-detection-with-deep-learning-and-opencv/
This python script demonstrates:
- How to load pre-trained Caffe model into OpenCV?
- Use this model to detect and localize objects in real-time video using OpenCV.
'''
